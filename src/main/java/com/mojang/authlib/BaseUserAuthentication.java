   ...
   public void loadFromStorage(Map<String, Object> credentials) {
      ...
      if (credentials.containsKey("displayName") && credentials.containsKey("uuid")) {
         ...
         if (credentials.containsKey("profileProperties")) {
            try {
               for (Map<String, String> propertyMapx : (List<Map<String, String>>) credentials.get("profileProperties")) {
                  String name = propertyMapx.get("name");
                  String value = propertyMapx.get("value");
                  String signature = propertyMapx.get("signature");
                  if (signature == null) {
